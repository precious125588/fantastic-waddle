...
export const MENU_CATEGORIES = [
  ...
  },
  {
    ...
    cmds: [
      ...
      { name: "chatgpt", desc: "ChatGPT conversation (alias)", wizard: true },
      { name: "gemi",    desc: "Google Gemini AI",             wizard: true },
      { name: "gemini",  desc: "Google Gemini AI (alias)",     wizard: true },
  ...
  },
  {
    ...
    cmds: [
      ...
      { name: "wikipedia", desc: "Wikipedia search (alias)", wizard: true },
  ...
  },
  {
    ...
    cmds: [
      ...
      { name: "remini",   desc: "Enhance photo with Remini AI", wizard: true },
  ...
  },
  {
    ...
    cmds: [
      ...
      { name: "demote",  desc: "Remove member's admin role",   wizard: true },
  ...
  },
  {
    ...
    cmds: [
      ...
      { name: "bio",      desc: "Get a contact's about/bio",   wizard: true },
  ...
  },
  {
    ...
    label: "System",
    cmds: [
      { name: "ping",    desc: "Bot latency",                  wizard: false },
  ...
  },
  {
    ...
    cmds: [
      ...
      { name: "getcmd",    desc: "View a saved command's source",     wizard: true  },
...
export function getAllCommands() {
  return MENU_CATEGORIES.flatMap(c => c.cmds.map(cmd => ({ ...cmd, category: c.id, categoryLabel: c.label })));
}
