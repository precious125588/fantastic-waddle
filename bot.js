...
// Suppress EFATAL polling errors — reconnect silently instead of flooding console
bot.on('polling_error', (err) => {
  if (err.code === 'EFATAL' || (err.message && err.message.includes('EFATAL'))) {
    // Don't log — this is a network blip or invalid token; we'll retry automatically
    return;
  }
  // Log other real errors once
